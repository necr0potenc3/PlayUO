namespace Client
{
    ...
    public class Snow : IParticle
    {
        ...
        private static CustomVertex.TransformedColoredTextured[] m_vSnowPool = VertexConstructor.Create();
        ...
        public Snow(Random rnd)
        {
            ...
            double d = 3.1415926535897931 * (0.4 + (rnd.NextDouble() * 0.2));
            this.m_Angle = d;
        ...
        public void Destroy()
        {
            ...
            {
                Engine.Effects.Add(new Snow(this.m_Random));
            }
        }
        ...
        public bool Slice()
        {
            if (this.m_OnScreen || (this.m_Slices++ >= this.m_SliceCheck))
            {
                ...
                {
                    this.m_Image.Draw(x, y, 0xfafaff, m_vSnowPool);
                }
            }
            return true;
        }
