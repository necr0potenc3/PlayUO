namespace Client
{
    ...
    public class GHuePickerAll : Gump
    {
        ...
        public GHuePickerAll(int X, int Y, int Width, int Height) : base(X, Y)
        {
            do
            {
                this.xSize++;
        ...
        protected internal override void Draw(int X, int Y)
        {
            ...
            Renderer.SolidRect(0x80ffff, (X + (this.m_xShade * this.xSize)) + ((this.xSize - 3) / 2), (Y + (((this.m_zShade * 10) + this.m_yShade) * this.ySize)) + ((this.ySize - 1) / 2), 3, 1);
            Renderer.SolidRect(0x80ffff, (X + (this.m_xShade * this.xSize)) + ((this.xSize - 1) / 2), (Y + (((this.m_zShade * 10) + this.m_yShade) * this.ySize)) + ((this.ySize - 3) / 2), 1, 3);
