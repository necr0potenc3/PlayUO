                        ...
                        if (m != null)
                        {
                            ...
                            if ((((num9 < num6) && (num11 >= cellX)) && (num10 < num7)) && (num12 >= cellY))
                            {
                                ...
                                Label_0275:
                                    num19 = 8;
                                Label_027A:
                                    if (Map.m_ItemFlags[num18 & 0x3fff][TileFlag.Bridge] || Map.m_ItemFlags[num18 & 0x3fff][TileFlag.Surface])
                                    {
                                    ...
                                    else
                                    {
                                        ...
                                        if ((item2.Z >= (num19 + ((this.m_Level - 1) * 20))) && (item2.Z <= ((num19 + ((this.m_Level - 1) * 20)) + 2)))
                                        {
                                            ...
                                            int num21 = m_RouteMap[num18 & 0x3fff];
                                            if (num21 != 0)
                                            {
                                                num18 = num21;
                                                flag2 = true;
                                    ...
                                    if (!flag2 && ((((num18 == 0x4001) || (num18 == 0x5796)) || ((num18 == 0x61a4) || (num18 == 0x6198))) || ((num18 == 0x61bc) || (num18 == 0x6199))))
                                    {
                                        flag2 = true;
                                    }
                                Label_03C6:
                                    if (flag2)
                                    {
                                        map.cells[num16, num17].Add(StaticItem.Instantiate((short)num18, item2.ItemID, (sbyte)(item.Z + item2.Z), num14 | (j << 0x10)));
                                    }
                                }
                            }
                        }
